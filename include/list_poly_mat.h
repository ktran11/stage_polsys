...
slong nmod_list_poly_mat_nrows(const nmod_poly_mat_t pol_mat)
{
  return pol_mat->rdim;
}

slong nmod_list_poly_mat_ncols(const nmod_poly_mat_t pol_mat)
{
  return pol_mat->cdim;
}

void nmod_list_poly_mat_init(nmod_list_poly_mat_t res, slong rdim, slong cdim,
			     slong degree, mp_limb_t modulus);
